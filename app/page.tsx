...
import GlitchText from './components/GlitchText'; // Import our new component
      ...
      <div className="hidden lg:block">
        <div className="absolute bottom-0 right-0 translate-x-1/4 translate-y-1/4">
          ...
          >
            <Card>
              <div className="p-8">
                <GlitchText className="text-7xl" enableOnHover={false} speed={2}>Code</GlitchText>
                <GlitchText className="text-7xl mb-4" enableOnHover={false} speed={2}>Engineer</GlitchText>
                <p className="text-2xl leading-tight font-bold">
                  Writing clean, efficient,<br />
                  and scalable code.
                </p>
              </div>
            </Card>
            <Card>
              <div className="p-8">
                <GlitchText className="text-7xl" enableOnHover={false} speed={2}>Tech</GlitchText>
                <GlitchText className="text-7xl mb-4" enableOnHover={false} speed={2}>Creator</GlitchText>
                <p className="text-2xl leading-tight font-bold">
            ...
            <Card>
              <div className="p-8">
                <GlitchText className="text-7xl" enableOnHover={false} speed={2}>Digital</GlitchText>
                <GlitchText className="text-7xl mb-4" enableOnHover={false} speed={2}>Builder</GlitchText>
                <p className="text-2xl leading-tight font-bold">
                  Bringing ideas to life from<br />
